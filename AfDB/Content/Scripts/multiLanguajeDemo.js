...
AfDB.createNameSpace = function (namespace) {
...
AfDB.createNameSpace("AfDB.Cookies");

AfDB.Cookies.getCookie = function (ck_name) {
...
AfDB.Cookies.setCookie = function (ck_name, value, exdays) {
    var exdate = new Date();
